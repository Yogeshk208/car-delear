 ...
 */
add_action('delete_attachment', 'bd_mr_delete_resized_images');
function bd_mr_image_resize($url, $width = null, $height = null, $crop = true, $align =
    'c', $retina = false)
{
    global $wpdb;
    // Get common vars (func_get_args() only get specified values)
    $common = bd_mr_common_info($url, $width, $height, $crop, $align, $retina);
...
function bd_mr_common_info($url, $width, $height, $crop, $align, $retina)
{
...
function bd_mr_delete_resized_images($post_id)
{
