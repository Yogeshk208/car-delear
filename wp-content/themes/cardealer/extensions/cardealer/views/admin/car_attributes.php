...
?>
			...
			function save_edited_car() {
				...
				if (is_required) {
					show_info_popup('<?php _e('Please fill all required fields!', 'cardealer'); ?>');
					return false;
				}
				return true;
			}
		...
		<div class="edit-form__entry">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<p>
						<a href="#" id="add_car_video" class="button orange icon-plus-squared"><?php _e('Add video', 'cardealer'); ?></a>
					</p>
