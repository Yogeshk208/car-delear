...
<p>
    <label for="<?php echo $widget->get_field_id('instagram_links'); ?>"><?php _e('Instagram Link', 'cardealer') ?>:</label>
...
<p>
    <label for="<?php echo $widget->get_field_id('instagram_tooltip'); ?>"><?php _e('Instagram Tooltip', 'cardealer') ?>:</label>
